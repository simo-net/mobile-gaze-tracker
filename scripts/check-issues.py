...
files = np.genfromtxt('/home/simonetunige/data/mobile-gaze/gaze-capture_google-split/issue_files.txt', dtype=str).tolist()
p = '/home/simonetunige/PycharmProjects/mobile-gaze-tracker/checkpoints/shape_predictor_68_face_landmarks.dat'
